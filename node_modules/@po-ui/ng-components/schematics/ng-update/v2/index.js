...
function updateToV2() {
    return schematics_1.chain([
        updatePackageJson('2.8.0', changes_1.dependeciesChanges),
        replace_1.replaceInFile('tslint.json', changes_1.tsLintReplaces),
        replace_1.replaceInFile('angular.json', changes_1.angularJsonReplaces),
        createUpgradeRule(),
        postUpdate()
    ]);
}
...
function createUpgradeRule() {
    return (tree, context) => {
        ...
        const workspace = project_1.getWorkspaceConfigGracefully(tree);
        if (workspace === null) {
...
function updatePackageJson(version, dependenciesChanges) {
    return (tree) => {
        if (tree.exists('package.json')) {
            ...
            json.dependencies = package_config_1.sortObjectByKeys(json.dependencies);
            json.devDependencies = package_config_1.sortObjectByKeys(json.devDependencies);
